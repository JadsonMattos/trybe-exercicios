...
const testBook = {
  ...
  pageQuantity: 1178,
  createdAt: '2021-09-28 01:00:00',
  updatedAt: '2021-09-28 01:00:00',
};
  ...
  describe('#getById', () => {
    ...
    describe('quando existe o livro', () => {
      ...
      it('a resposta é um objeto contendo os dados do livro', async () => {
        expect(book).to.deep.equals(testBook);
      });
    });
  ...
  describe('#update', () => {
    ...
    describe('quando existe o livro', () => {
      before(async () => {
        ...
        updatedBook = await BookService.update(2, testBook);
      });
    ...
    describe('quando não existe o livro', () => {
      before(async () => {
        ...
        updatedBook = await BookService.update(1000, testBook);
      });
  ...
  describe('#remove', () => {
    ...
    describe('quando não existe o livro', () => {
      before(async () => {
        ...
        removedBook = await BookService.remove(1000);
      });
