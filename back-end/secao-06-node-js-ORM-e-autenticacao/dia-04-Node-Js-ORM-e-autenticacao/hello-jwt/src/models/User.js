...
const DATA_PATH = psth.join(__dirname, '..', 'data', 'users.json');
...
const findOne = (username) => getAll().then((users) => users.find((user) => user.username === username));

const create = (username, password, admin) => getAll().then((users) => {
