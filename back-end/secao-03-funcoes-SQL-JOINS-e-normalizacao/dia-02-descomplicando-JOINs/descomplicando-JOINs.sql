...
SELECT stf.first_name, stf.last_name, AVG(pay.amount) AS `media de pagamento`
...
SELECT CONCAT(employee.first_name, " ", employee.last_name) AS "Nome Pessoa Colaboradora",
...
SELECT CONCAT(manager.first_name, " ", manager.last_name) AS "Nome Gerente",
    COUNT(*) FROM hr.employees AS manager
